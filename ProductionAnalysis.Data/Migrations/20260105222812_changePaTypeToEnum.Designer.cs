...
namespace ProductionAnalysis.Data.Migrations
{
    ...
    [Migration("20260105222812_changePaTypeToEnum")]
    partial class changePaTypeToEnum
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IndicatorDboTemplateDbo", b =>
                {
                    ...
                    b.HasKey("IndicatorsId", "TemplatesId");
            ...
            modelBuilder.Entity("ProductionAnalysis.Data.Models.Forms.FormRowDbo", b =>
                {
                    ...
                    b.Property<bool>("IsAdditionalOperation")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ProductionAnalysis.Data.Models.Forms.FormRowValueDbo", b =>
                {
                    ...
                    b.Property<string>("CumulativeValue")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("IndicatorDboTemplateDbo", b =>
                {
                    b.HasOne("ProductionAnalysis.Data.Models.Dictionaries.IndicatorDbo", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductionAnalysis.Data.Models.Dictionaries.ShiftScheduleDbo", b =>
                {
                    b.HasOne("ProductionAnalysis.Data.Models.Dictionaries.AdditionalOperationDbo", "AdditionalOperation")
                        .WithMany()
